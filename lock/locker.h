...
class sem {
 public:
  ...
  ~sem() { sem_destroy(&this->m_sem); }

  bool wait() { return sem_wait(&this->m_sem); }

  bool post() { return sem_post(&this->m_sem); }
...
class cond {
 public:
  ...
  ~cond() { pthread_cond_destroy(&this->m_cond); }
  ...
  bool signal() { return pthread_cond_signal(&this->m_cond) == 0; }

  bool broadcast() { return pthread_cond_broadcast(&this->m_cond) == 0; }
